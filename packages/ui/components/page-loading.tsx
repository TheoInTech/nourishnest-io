export const PageLoading = ({ text }: { text?: string }) => {
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 m-auto flex flex-col gap-4 items-center backdrop-blur-sm justify-center w-full h-full bg-opacity-95 bg-muted z-[999999] overflow-hidden">
